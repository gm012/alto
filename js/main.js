...
function animateNumbers() {
    ...
    stats.forEach((stat) => {
        ...
        let suffix = '';
        if (label && label.textContent.includes('Projects')) suffix = '+';
...
// ============================================ //
// REVEAL ANIMATIONS — IMPROVED EASING         //
// ============================================ //

// ----- Statement Section ----- //
gsap.fromTo('.statement-title',
    { y: 40, opacity: 0 },
    {
        scrollTrigger: {
            trigger: '.statement',
...
console.log('%c Digital Experience Studio ', 'color: #F2EFE8; font-size: 14px;');
